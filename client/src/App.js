...
function App() {
  ...
  return (
    <>
      ...
      {/* Start of Contact us */}
      <section id="contact" className="position-relative py-5 mt-5 m-2">
        ...
        <div className="d-none d-md-block position-absolute top-0 start-0 w-100 h-100">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4505.786597273222!2d122.69619606909616!3d8.07303522109427!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3253bfe60d7da18b%3A0xfffd51ecb6e7dc6e!2sVilla%20M.%20Tejero!5e1!3m2!1sen!2sph!4v1708416059622!5m2!1sen!2sph"
            width="100%"
            height="100%"
            allowfullscreen=""
            loading="lazy"
          ...
          <Container>
            <Row style={{ marginTop: '-20' }}>
              <Col md={6} xl={5} xxl={4} className="offset-md-6 offset-xl-7 offset-xxl-8">
                <div>
                  <Form className="border rounded shadow p-3 p-md-4 p-lg-5" style={{ background: 'rgba(255, 255, 255, 0.6)', backdropFilter: 'blur(10px)' }}>
        ...
        <Container>
          <Row className="row-cols-1 row-cols-lg-3 row-cols-lg-4">
            <Col>
              <div className="d-flex align-items-center p-3" style={{ fontSize: '13px' }}>
                <div className="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                  <svg className="bi bi-telephone" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" viewBox="0 0 16 16">
            ...
            <Col>
              <div className="d-flex align-items-center p-3" style={{ fontSize: '13px' }}>
                <div className="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                  <svg className="bi bi-envelope" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" viewBox="0 0 16 16">
            ...
            <Col>
              <div className="d-flex align-items-center p-3" style={{ fontSize: '13px' }}>
                <div className="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                  <svg className="bi bi-pin" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" viewBox="0 0 16 16">
            ...
            <Col>
              <div className="d-flex align-items-center p-3" style={{ fontSize: '13px' }}>
                <div className="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                  <svg className="bi bi-facebook" xmlns="http://www.w3.org/2000/svg" width="2em" height="1em" fill="currentColor" viewBox="0 0 16 16">
